  ...
  // ===== P1: Perplexity vs Grok vs Gemini — AI搜索工具对比 =====
  {
    ...
    content: [
      ...
      },
      {
        type: 'callout',
        calloutType: 'info',
        content: '评测基于各平台2026年5月可用版本：Perplexity (Pro, GPT-4o + Claude模型可选)、Grok 3 (xAI)、Gemini 2.5 Pro。所有搜索测试均在相近时间段内完成，力求公平对比。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。',
      },
      {
        type: 'heading',
        level: 1,
      ...
      },
      {
        type: 'callout',
        calloutType: 'warning',
        content: '免责声明：本评测基于我们的主观使用体验，搜索结果可能因时间和地区而异。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。建议充分利用各平台的免费试用再做决定。',
      },
      {
        type: 'heading',
        level: 2,
  ...
  // ===== Google Veo 3 vs Hailuo AI vs Seedance 2：AI视频新三国 =====
  {
    ...
    content: [
      ...
      },
      {
        type: 'callout',
        calloutType: 'warning',
        content: '免责声明：本评测基于我们的主观使用体验，结果可能因提示词、使用场景和平台版本而异。所有价格基于2026年5月官网定价，可能随时间调整。AI视频生成技术仍在快速迭代中，建议关注各平台的最新动态。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。Sora已于2026年4月26日停止服务，本评测不再纳入对比。',
      },
      {
        type: 'heading',
        level: 2,
  ...
  // ===== P12: Bolt vs Lovable AI 全栈应用构建器对决 =====
  {
    ...
    content: [
      ...
      },
      {
        type: 'callout',
        calloutType: 'warning',
        content: '免责声明：本评测基于我们的主观使用体验，结果可能因需求描述方式、使用场景和平台版本而异。所有价格基于2026年5月官网定价，可能随时间调整。AI应用构建领域仍在快速迭代中，建议关注各平台的最新动态。把AI生成的代码投入生产前，务必做好代码审查和安全审计。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。',
      },
      {
        type: 'heading',
        level: 2,
  ...
  // ===== R12: Midjourney V8.1 vs GPT Image 2 vs Flux (FLUX.2) =====
  {
    ...
    content: [
      ...
      },
      {
        type: 'callout',
        calloutType: 'info',
        content: '评测基于2026年5月各平台最新版本：Midjourney V8.1 (Discord端)、GPT Image 2 (ChatGPT Plus)、FLUX.2 (BFL API + 开源版)。所有测试使用相同的提示词，力求公平。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。',
      },
      {
        type: 'heading',
        level: 1,
      ...
      },
      {
        type: 'callout',
        calloutType: 'warning',
        content: '免责声明：本评测基于我们的主观使用体验，结果可能因提示词、使用场景和平台版本而异。所有价格基于2026年5月官网定价，可能随时间调整。Midjourney正在开发Conversational Mode和网站重构，发布后使用体验可能大幅改变。AI生成图片用于商业用途时，请注意各平台的使用条款和版权政策。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。',
      },
      {
        type: 'heading',
        level: 2,
  ...
  // ===== P1: Runway Gen-4 vs Kling 3.0 vs Vidu — 专业级视频生成对决 =====
  {
    ...
    content: [
      ...
      },
      {
        type: 'callout',
        calloutType: 'warning',
        content: '免责声明：本评测基于我们的主观使用体验，结果可能因使用场景、提示词质量和网络环境而异。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。建议充分利用各平台的免费试用再做决定。AI视频技术在快速演进，本文信息截至2026年5月底。',
      },
      {
        type: 'heading',
        level: 2,
  ...
  // ===== P0: Cursor vs Windsurf vs GitHub Copilot AI编程IDE对决 =====
  {
    ...
    content: [
      ...
      },
      {
        type: 'callout',
        calloutType: 'warning',
        content: '免责声明：本评测基于我们的主观使用体验和公开信息，结果可能因具体项目类型、代码规模、编程语言和个人偏好而异。价格为2026年5月的信息，可能随时变动。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。建议充分利用各平台的免费试用再做决定。AI编程技术在极速演进，本文信息截至2026年5月底。',
      },
      {
        type: 'heading',
        level: 2,
  ...
  // ===== P15: DeepSeek vs Qwen vs Kimi 国产开源三强 =====
  {
    ...
    content: [
      ...
      },
      {
        type: 'callout',
        calloutType: 'warning',
        content: '免责声明：本评测基于公开数据和我们的主观使用体验，模型能力和定价可能随时变化。DeepSeek V4的API价格截至2026年5月22日已锁定为永久降价后的水平。Qwen和Kimi的价格以各自官方平台为准。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。建议充分利用免费额度试用以做出最适合自己的选择。',
      },
      {
        type: 'heading',
        level: 2,
  ...
  // ===== P0: MiniMax M3 vs Claude Opus 4.8 vs GPT-5.5 =====
  {
    ...
    content: [
      ...
      },
      {
        type: 'callout',
        calloutType: 'info',
        content: '评测基于各平台2026年6月可用版本：MiniMax M3（稀宇科技，自研MSA稀疏注意力架构）、Claude Opus 4.8（Anthropic，SWE-Bench Pro 69.2%）、ChatGPT GPT-5.5（OpenAI，Codex Computer Use全平台）。所有编程测试在相同环境进行。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。',
      },
      {
        type: 'heading',
        level: 1,
      ...
      },
      {
        type: 'callout',
        calloutType: 'warning',
        content: '免责声明：MiniMax M3于2026年6月1日刚发布，本文评测基于早期版本和公开Benchmark数据，长期稳定性有待更多用户验证。所有价格基于2026年6月官方公布信息，可能随时调整。本文当前未使用个性化联盟链接；如未来接入，会在按钮与页面披露中明确标注。建议充分利用各平台的免费试用再做决定。',
      },
      {
        type: 'heading',
        level: 2,
